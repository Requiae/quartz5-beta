...
As an action, you can cause the hand to crush the [[Conditions#Restrained|restrained]] target, which must make a Strength saving throw. The target takes `2d6` bludgeoning damage on a failed save, or half as much damage on a successful one.
