...
Heavy chains, firmly rooted in the ground, hold the target in place. The target is [[Conditions#Restrained|restrained]] until the spell ends, and it can't move or be moved by any means until then.
...
A _[[Dispel Magic|dispel magic]]_ spell can end the spell only if it is cast as a 9th-level spell, targeting either the prison or the special component used to create it.
