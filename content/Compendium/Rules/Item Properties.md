...
Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with the _[[Remove Curse|remove curse]]_ spell.

## Poison

Given their insidious and deadly nature, poisons are illegal in most societies but are a favourite tool among assassins, drow, and other evil creatures.
